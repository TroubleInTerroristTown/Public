...
public void OnPluginStart()
{
    ...
    g_cPrice = AutoExecConfig_CreateConVar("teleporter_price", "5000", "The amount of credits Teleporter costs as traitor. 0 to disable.");
    g_cPrio = AutoExecConfig_CreateConVar("teleporter_sort_prio", "0", "The sorting priority of the Teleporter in the shop menu.");
    g_cCount = AutoExecConfig_CreateConVar("teleporter_count", "3", "How often a players can port him back to the location");
    TTT_EndConfig();
