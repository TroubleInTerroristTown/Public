...
void RegisterItem()
{
    ...
    TTT_RegisterShopItem(T_SHORT_NAME, sBuffer, g_cTPrice.IntValue, TTT_TEAM_INNOCENT, g_cTPrio.IntValue, 1, g_cTLimit.IntValue, OnItemPurchased);
    ...
    TTT_RegisterShopItem(D_SHORT_NAME, sBuffer, g_cDPrice.IntValue, TTT_TEAM_INNOCENT, g_cDPrio.IntValue, 1, g_cDLimit.IntValue, OnItemPurchased);
