...
public void OnPluginStart()
{
    ...
    g_cPrice = AutoExecConfig_CreateConVar("fakename_price", "0", "The amount of credits fakename costs as traitor. 0 to disable.");
    ...
    g_cIgnoreRole = AutoExecConfig_CreateConVar("fakename_ignore_role", "-1", "Which role should be ignored when traitor use fakename? -1 - Disabled ( https://github.com/Bara/TroubleinTerroristTown/wiki/CVAR-Masks )", _, true, 2.0);

    g_cInviLongName = AutoExecConfig_CreateConVar("invisible_name_name", "Invisible Name", "The name of this in Shop");
    g_cInviPrice = AutoExecConfig_CreateConVar("invisible_name_price", "0", "The amount of credits invisiblename costs as traitor. 0 to disable.");
