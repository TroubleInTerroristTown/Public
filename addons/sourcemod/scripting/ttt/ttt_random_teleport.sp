...
public void OnPluginStart()
{
    ...
    g_cTPrice = AutoExecConfig_CreateConVar("rt_traitor_price", "0", "The amount of credits for Random Teleport costs as traitor. 0 to disable.");
    ...
    g_cTCount = AutoExecConfig_CreateConVar("rt_traitor_count", "0", "The amount of usages for Random Teleports per round as traitor. 0 to disable.");
    g_cDCount = AutoExecConfig_CreateConVar("rt_detective_count", "0", "The amount of usages for Random Teleports per round as detective. 0 to disable.");
    g_cICount = AutoExecConfig_CreateConVar("rt_innocent_count", "0", "The amount of usages for Random Teleports per round as innocent. 0 to disable.");
    g_cRagdoll = AutoExecConfig_CreateConVar("rt_teleport_ragdolls", "0", "Teleport with dead players (ragdoll)?", _, true, 0.0, true, 1.0);
