void SetupConfig()
{
	...
	g_cPanoramaMessages = AutoExecConfig_CreateConVar("ttt_enable_panorama_messages", "1", "Enable new messages (Colors aren't supported!) for panorama players?", _, true, 0.0, true, 1.0);
