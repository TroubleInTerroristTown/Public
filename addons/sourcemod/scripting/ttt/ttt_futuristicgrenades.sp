...
public void OnPluginStart()
{
    ...
    g_cPriceFI = AutoExecConfig_CreateConVar("futuristic_price_innocent", "0", "The amount of credits futuristic grenades costs as innocent. 0 to disable.");
    g_cPriceFT = AutoExecConfig_CreateConVar("futuristic_price_traitor", "0", "The amount of credits futuristic grenades costs as traitor. 0 to disable.");
    g_cPriceFD = AutoExecConfig_CreateConVar("futuristic_price_detective", "0", "The amount of credits futuristic grenades costs as detective. 0 to disable.");
    ...
    g_cPriceFFI = AutoExecConfig_CreateConVar("forcefield_price_innocent", "0", "The amount of credits forcefield grenades costs as innocent. 0 to disable.");
    g_cPriceFFT = AutoExecConfig_CreateConVar("forcefield_price_traitor", "0", "The amount of credits forcefield grenades costs as traitor. 0 to disable.");
    g_cPriceFFD = AutoExecConfig_CreateConVar("forcefield_price_detective", "0", "The amount of credits forcefield grenades costs as detective. 0 to disable.");
    ...
    g_cPriceBHI = AutoExecConfig_CreateConVar("blackhole_price_innocent", "0", "The amount of credits blackhole grenades costs as innocent. 0 to disable.");
    g_cPriceBHT = AutoExecConfig_CreateConVar("blackhole_price_traitor", "0", "The amount of credits blackhole grenades costs as traitor. 0 to disable.");
    g_cPriceBHD = AutoExecConfig_CreateConVar("blackhole_price_detective", "0", "The amount of credits blackhole grenades costs as detective. 0 to disable.");
    ...
    g_cPriceFEI = AutoExecConfig_CreateConVar("explosion_price_innocent", "0", "The amount of credits explosion grenades costs as innocent. 0 to disable.");
    g_cPriceFET = AutoExecConfig_CreateConVar("explosion_price_traitor", "0", "The amount of credits explosion grenades costs as traitor. 0 to disable.");
    g_cPriceFED = AutoExecConfig_CreateConVar("explosion_price_detective", "0", "The amount of credits explosion grenades costs as detective. 0 to disable.");
    ...
    g_cPriceFII = AutoExecConfig_CreateConVar("implosion_price_innocent", "0", "The amount of credits implosion grenades costs as innocent. 0 to disable.");
    g_cPriceFIT = AutoExecConfig_CreateConVar("implosion_price_traitor", "0", "The amount of credits implosion grenades costs as traitor. 0 to disable.");
    g_cPriceFID = AutoExecConfig_CreateConVar("implosion_price_detective", "0", "The amount of credits implosion grenades costs as detective. 0 to disable.");
